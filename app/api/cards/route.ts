...
export async function GET(req: Request) {
  ...
  if (business) {
    if (!['ValuePropositions','KeyActivities','KeyResources','CustomerRelationships','CustomerSegments'].includes(business)) {
...
export async function POST(req: Request) {
  ...
  const b = (body ?? {}) as { text?: string; status?: string; business?: 'ValuePropositions'|'KeyActivities'|'KeyResources'|'CustomerRelationships'|'CustomerSegments' }
  ...
  const business: 'ValuePropositions'|'KeyActivities'|'KeyResources'|'CustomerRelationships'|'CustomerSegments' =
    (b.business === 'KeyActivities' || b.business === 'KeyResources' || b.business === 'CustomerRelationships' || b.business === 'CustomerSegments') ? b.business : 'ValuePropositions'
